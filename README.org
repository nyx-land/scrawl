...
s-expressions, is implemented within CL using reader macros, and that
uses Common Doc as the document representation backend. It uses [[https://github.com/fosskers/parcom/][parcom]]
to implement the actual parsing, and because it's implemented as
reader macros in Common Lisp, you can use any CL implementation as the
"compiler" backend for Scrawl.
...
I'm releasing this publicly. This is an active project that I plan to
replace org-mode with and use extensively for my writing; there will
be many forthcoming changes and improvements!
